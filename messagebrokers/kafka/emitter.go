...
func NewKafkaEventEmitterFromEnvironment() (messagebrokers.EventEmitter, error) {
...
func NewKafkaEventEmitter(client sarama.Client) (messagebrokers.EventEmitter, error) {
...
func (k *kafkaEventEmitter) Emit(evt messagebrokers.Event) error {
