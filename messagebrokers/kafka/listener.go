...
func NewKafkaEventListenerFromEnvironment() (messagebrokers.EventListener, error) {
...
func NewKafkaEventListener(client sarama.Client, partitions []int32) (messagebrokers.EventListener, error) {
...
func (k *kafkaEventListener) Listen(events ...string) (<-chan messagebrokers.Event, <-chan error, error) {
	var err error

	topic := "events"
	results := make(chan messagebrokers.Event)
...
func (l *kafkaEventListener) Mapper() messagebrokers.EventMapper {
	return l.mapper
}
